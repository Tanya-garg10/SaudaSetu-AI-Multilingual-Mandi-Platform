...
exports.clearMockData = exports.createMockData = void 0;
...
const createMockData = async () => {
    try {
        ...
        const createdUsers = await User_1.default.insertMany(mockUsers);
        ...
        const createdProducts = await Product_1.default.insertMany(mockProducts);
        ...
        const createdNegotiations = await Negotiation_1.default.insertMany(mockNegotiations);
...
const clearMockData = async () => {
    try {
        ...
        await Negotiation_1.default.deleteMany({});
